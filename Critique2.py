"""Programme qui crée les graphes des erreurs d'estimations des rendements, variances, covariances et corrélation"""
...
#rendement et variance historique et ex-post
...
#covariance historique et ex-post
...
#correlation historique et ex-post + décile
corr_data = {}
for i in range(Hist-1, nb_row- Fut -1):
